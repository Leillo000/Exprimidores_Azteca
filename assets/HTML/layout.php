...
<head>
    ...
    <link rel="stylesheet" href="http://192.168.1.128/Codigo_Exprimidores_Azteca/assets/CSS/style.css">
            ...
            <li>
                ...
                <button onclick=toggleSidebar() id="toggle_btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        class="icon icon-tabler icons-tabler-outline icon-tabler-chevrons-right" id="row">
